...
Deremon wciąż wzbogaca AROSową bibliotekę C o "wide character support", dodając brakujące funkcje. 

Matthias ‘Mazze’ Rustler cały czas pracuje nad stroną [www.aros.org](htps://www.aros.org) dostosowując ją do współczesnych standardów. Zmiany możemy obserwować na bieżąco.
